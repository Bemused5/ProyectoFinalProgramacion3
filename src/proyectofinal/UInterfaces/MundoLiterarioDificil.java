 ...
 * @author daasa
 */
public class MundoLiterarioDificil extends javax.swing.JFrame {
     ...
     */
    public MundoLiterarioDificil(int idJuego,int userID) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(panelNivel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 420, 40, 40));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 470, 590, 80));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 550, 610, 40));
        ...
        jLabel17.setText("Validar Respuesta");

        javax.swing.GroupLayout jPanel2Layout = new javax.swing.GroupLayout(jPanel2);
        jPanel2.setLayout(jPanel2Layout);
        jPanel2Layout.setHorizontalGroup(
            jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jLabel17, javax.swing.GroupLayout.DEFAULT_SIZE, 450, Short.MAX_VALUE)
        );
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 610, 450, 70));
    ...
    private void jPanel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel2MouseClicked
        // Recuperar la información de jTextField1.
        textoDelCampo= jTextField1.getText();
        
        try {
            verificarRespuesta(textoDelCampo);
        } catch (InterruptedException ex) {
            Logger.getLogger(MundoLiterarioDificil.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    // El nivel corresponde al número del panelNivel clickeado
        String[] datos = null;
        try (InputStream inputStream = getClass().getResourceAsStream("/proyectofinal/UInterfaces/resources/dataMundoLiterarioDificil.txt");
    ...
    // Cargar datos desde el archivo
        ...
        if (preguntaYRespuestas != null && preguntaYRespuestas.length == 2) {
            ...
            respuestaCorrecta = preguntaYRespuestas[1];
        ...
        public void run() {
            ...
            if (tiempoRestante < 0) {
                ...
                if (vidas == 0) {
                    ...
                    MundoLiterarioDificil mundoLiterario = new MundoLiterarioDificil();
    ...
    private void verificarRespuesta(String respuestaSeleccionada) throws InterruptedException {
        ...
        if (respuestaSeleccionada.equalsIgnoreCase(respuestaCorrecta)) {
            ...
            if(nivelSeleccionado==1){
                System.out.println(intentosNivel1);
                jLabelPregunta.setVisible(false);
                jScrollPane1.setVisible(false);
                Temporizador.setVisible(false);
                jPanel2.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        public void run() {
            MundoLiterarioDificil ml = new MundoLiterarioDificil(idJuegoF,userIDF);
            ml.setVisible(true);
