 ...
 * @author daasa
 */
public class Actividad5_1 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Actividad5_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
