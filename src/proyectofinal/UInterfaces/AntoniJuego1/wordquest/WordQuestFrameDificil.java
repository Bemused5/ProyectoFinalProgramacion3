...
public class WordQuestFrameDificil extends javax.swing.JFrame {
    ...
    public WordQuestFrameDificil() {
        ...
        //5 niveles mas
        lista.add(new DataWordQuest("Algorithm", "Perpendicular", "irrefutable", "love"));
        lista.add(new DataWordQuest("mechanic", "videogame", "movie", "computer"));
        lista.add(new DataWordQuest("medicine", "pills", "medkit", "bandages"));
        lista.add(new DataWordQuest("running", "sprinting", "jumping", "fliying"));
        lista.add(new DataWordQuest("swingin", "winning", "riding", "playing"));
        ...
        tempo.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                if (puntaje == 10 && puntaje < 100 && !tiempoAñadido) {
                ...
                if (puntaje == 20 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 30 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 40 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 50 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 60 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 70 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 80 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
                }
                if (puntaje == 90 && puntaje < 100 && !tiempoAñadido) {
                    tiempoRestante += 60; // Agrega 60 segundos al tiempo
                    tiempoAñadido = true; // Marca que ya se ha añadido tiempo en el nivel actual
                    inicializarTablero(); // Mostrar nuevas palabras
                    mostrarTablero();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(WordQuestFrameDificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new WordQuestFrameDificil().setVisible(true);
            }
        });
    }
