...
public class ModifyUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Da click en el boton seleccionar para empezar a modificar la data del usuario");
        ...
        jPanelSeleccionar.setBackground(java.awt.Color.red);
        ...
        jLabel3.setText("Seleccionar Usuario Seleccionado");
        ...
        jPanel1.add(jPanelSeleccionar, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 660, 370, 70));
    ...
    private void jPanelSeleccionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelSeleccionarMouseClicked
        ...
        if (selectedUsuario != null) {
            ...
            jTextTipo.setText(String.valueOf(selectedUsuario.getUserTipe()));
        } else {
            JOptionPane.showMessageDialog(this, "Por favor, seleccione un usuario primero.");
        }
    ...
    private void jPanelModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanelModificarMouseClicked
        ...
        if (selectedUsuario != null && validateTextFields()) {
            updateUsuarioInDB(
                ...
                Integer.parseInt(jTextTipo.getText())
            );
            clearTextFields();
            updateUsuarioList(); // Actualiza la lista después de modificar
        } else {
