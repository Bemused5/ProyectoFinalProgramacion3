 ...
 * @author daasa
 */
public class MenuCentroDeControl extends javax.swing.JFrame {
     ...
     * @param userID
     */
    public MenuCentroDeControl(int userID) {
        userIDF=userID;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecciona tu opcion de preferencia");
        ...
        jLabel5.setText("Puedes modificar tu información o ver tus puntuaciones a lo largo del tiempo");
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 120, -1, 80));
        ...
        jLabel4.setText("Modificar mi información");
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 310, 380, 90));
        ...
        jLabel9.setText("Ver mis puntuaciones");
        ...
        jPanel1.add(jPanel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 530, 380, 90));
    ...
    private void jPanel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel5MouseClicked
        ModifyUser modifyUser = new ModifyUser(userIDF);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuCentroDeControl.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuCentroDeControl(userIDF).setVisible(true);
            }
        });
    }
