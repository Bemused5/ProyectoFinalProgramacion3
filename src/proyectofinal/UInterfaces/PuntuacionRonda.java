 ...
 * @author daasa
 */
public class PuntuacionRonda extends javax.swing.JFrame {
     ...
     */
    public PuntuacionRonda(int userID,int puntuacion,int idJuego,int ronda) {
        userIDF = userID;
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/proyectofinal/UInterfaces/resources/motivacion.png"))); // NOI18N
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 260, -1));

        jLabel4.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 48)); // NOI18N
        jLabel4.setText("100");
        jPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 250, -1, -1));
        ...
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 250, 260, -1));
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        Anagrama anagrama = new Anagrama(puntuacionF,5,userIDF,rondaF);
        
        if(rondaF==5){
            Ranking ranking = new Ranking(userIDF,idJuegoF);
            Puntuacion puntuacion = new Puntuacion();
            puntuacion.almacenarPuntuacion(idJuegoF, puntuacionF, userIDF);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PuntuacionRonda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PuntuacionRonda(userIDF,puntuacionF,idJuegoF,rondaF).setVisible(true);
            }
        });
    }
