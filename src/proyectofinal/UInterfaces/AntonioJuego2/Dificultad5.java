 ...
 * @author jacr3
 */
public class Dificultad5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Selecciona la difucltad de tu viaje ");

        jButton1.setText("De paseo ( Estandar)");
        ...
        jButton2.setText("Experto en historia (Dificil)");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ERA5Dificil E5D = new ERA5Dificil();
        E5D.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dificultad5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dificultad5().setVisible(true);
            }
        });
    }
