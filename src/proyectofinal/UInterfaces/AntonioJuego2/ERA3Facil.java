 ...
 * @author jacr3
 */
public class ERA3Facil extends javax.swing.JFrame {
    ...
    public ERA3Facil() {
        ...
        new Preguntas("¿En qué siglo comenzó la Revolución Industrial?", "Siglo XVI", "Siglo XVII", "Siglo XVIII", "Siglo XIX", "Siglo XVIII"),
        new Preguntas("¿Qué tipo de energía se comenzó a usar ampliamente durante la Revolución Industrial?", "Energía solar", "Energía de vapor", "Energía eólica", "Energía hidráulica", "Energía de vapor"),
        new Preguntas("¿Qué invento mejoró la producción de textiles durante la Revolución Industrial?", "La imprenta", "El telar mecánico", "La bombilla eléctrica", "El teléfono", "El telar mecánico"),
        new Preguntas("¿En qué industria comenzó principalmente la Revolución Industrial?", "Agricultura", "Textil", "Automotriz", "Tecnología", "Textil"),
        new Preguntas("¿Qué país fue el líder de la Revolución Industrial?", "Francia", "Estados Unidos", "Alemania", "Reino Unido", "Reino Unido"),
        new Preguntas("¿Cómo afectó la Revolución Industrial a las ciudades?", "Las ciudades se hicieron más pequeñas", "Muchas personas se mudaron a las ciudades", "Las ciudades perdieron importancia económica", "Las ciudades se volvieron menos pobladas", "Muchas personas se mudaron a las ciudades"),
        new Preguntas("¿Qué medio de transporte se volvió común con la Revolución Industrial?", "Automóviles", "Bicicletas", "Trenes", "Veleros", "Trenes"),
        new Preguntas("¿Quién fue uno de los pioneros de la producción en masa?", "Nikola Tesla", "Henry Ford", "Isaac Newton", "Albert Einstein", "Henry Ford"),
        new Preguntas("¿Qué elemento químico se utilizó para iluminación antes de la invención de la bombilla eléctrica?", "Hidrógeno", "Oxígeno", "Neón", "Gas", "Gas"),
        new Preguntas("¿Qué revolución siguió a la Revolución Industrial, cambiando la forma en que se procesaba la información?", "La Revolución Informática", "La Revolución Francesa", "La Revolución Rusa", "La Revolución Americana", "La Revolución Informática")
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ERA3Facil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
