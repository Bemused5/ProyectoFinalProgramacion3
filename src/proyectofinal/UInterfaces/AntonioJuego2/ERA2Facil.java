 ...
 * @author jacr3
 */
public class ERA2Facil extends javax.swing.JFrame {
    ...
    public ERA2Facil() {
        ...
        new Preguntas("¿Qué gran imperio cayó al principio de la Edad Media?", "Imperio Británico", "Imperio Mongol", "Imperio Romano de Occidente", "Imperio Persa", "Imperio Romano de Occidente"),
        new Preguntas("¿Qué sistema económico y social predominaba en la Edad Media?", "Capitalismo", "Feudalismo", "Comunismo", "Mercantilismo", "Feudalismo"),
        new Preguntas("¿Qué evento marcó el final de la Edad Media?", "La Revolución Francesa", "La caída de Constantinopla", "El descubrimiento de América", "La invención de la imprenta", "La caída de Constantinopla"),
        new Preguntas("¿Qué edificio solía ser el centro de un pueblo medieval?", "La fábrica", "El mercado", "La iglesia o catedral", "El banco", "La iglesia o catedral"),
        new Preguntas("¿Qué título recibía el señor que gobernaba un feudo?", "Caballero", "Emperador", "Conde", "Señor feudal", "Señor feudal"),
        new Preguntas("¿Quiénes eran los combatientes entrenados que servían a los señores feudales?", "Gladiadores", "Legionarios", "Caballeros", "Arqueros", "Caballeros"),
        new Preguntas("¿Cuál fue una de las enfermedades más mortales que afectó a Europa en la Edad Media?", "La gripe", "La peste bubónica", "El cólera", "La viruela", "La peste bubónica"),
        new Preguntas("¿Cómo se llamaban las expediciones militares de los cristianos para recuperar Tierra Santa?", "Las Cruzadas", "Las Guerras Púnicas", "Las Guerras Napoleónicas", "Los Viajes de Marco Polo", "Las Cruzadas"),
        new Preguntas("¿Qué nombre recibía la tierra cultivable común en un feudo?", "Terrafirma", "Campo", "Tierras de nadie", "Territorio comunal", "Territorio comunal"),
        new Preguntas("¿Qué tipo de armadura comenzaron a utilizar los caballeros en la Alta Edad Media?", "Armadura de cuero", "Armadura de tela", "Armadura de placas", "Armadura de malla", "Armadura de malla")
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ERA2Facil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
