 ...
 * @author jacr3
 */
public class ERA3Dificil extends javax.swing.JFrame {
    ...
    public ERA3Dificil() {
        ...
        new Preguntas("¿Qué inventor es conocido por mejorar la máquina de vapor que se convirtió en fundamental para la Revolución Industrial?", "Thomas Newcomen", "James Watt", "Michael Faraday", "Alexander Graham Bell", "James Watt"),
        new Preguntas("¿Qué filósofo económico escribió 'La riqueza de las naciones', que influenció el pensamiento económico durante la Revolución Industrial?", "John Maynard Keynes", "Karl Marx", "Adam Smith", "Thomas Malthus", "Adam Smith"),
        new Preguntas("¿Qué evento histórico aceleró la Revolución Industrial en América del Norte?", "La Guerra Civil Americana", "La independencia de los Estados Unidos", "La Guerra de 1812", "La Revolución Francesa", "La Guerra Civil Americana"),
        new Preguntas("¿Qué innovación tecnológica mejoró significativamente la comunicación durante la Revolución Industrial?", "El telégrafo", "La radio", "El teléfono", "El Internet", "El telégrafo"),
        new Preguntas("¿Qué sistema empezó a desaparecer debido al aumento de la producción industrial y la mecanización del trabajo?", "El capitalismo", "El sistema gremial", "El mercantilismo", "El feudalismo", "El sistema gremial"),
        new Preguntas("¿Qué impacto tuvo la Revolución Industrial en la estructura social?", "Reforzó el sistema de castas", "Creó una clara división entre las clases sociales", "Disminuyó la diferencia entre ricos y pobres", "Eliminó la clase obrera", "Creó una clara división entre las clases sociales"),
        new Preguntas("¿Cuál fue uno de los primeros y más importantes canales construidos que conectaba el interior de Inglaterra con los puertos marítimos?", "Canal de Suez", "Gran Canal de China", "Canal de Erie", "Canal de Bridgewater", "Canal de Bridgewater"),
        new Preguntas("¿Cuál fue el principal combustible utilizado en las máquinas de vapor durante la Revolución Industrial?", "Madera", "Carbón", "Petróleo", "Gas natural", "Carbón"),
        new Preguntas("¿Qué teoría fue desarrollada para explicar el proceso de selección natural y la evolución durante la Revolución Industrial?", "Teoría del Big Bang", "Teoría de la Relatividad", "Teoría de la Gravedad", "Teoría de la Evolución", "Teoría de la Evolución"),
        new Preguntas("¿Qué movimiento artístico y literario surgió como una reacción a los cambios de la Revolución Industrial?", "Romanticismo", "Realismo", "Impresionismo", "Clasicismo", "Romanticismo")        
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ERA3Dificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ERA3Dificil().setVisible(true);
            }
        });
    }
