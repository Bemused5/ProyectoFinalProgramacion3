...
public class NivelDificultad extends javax.swing.JFrame {
     ...
     */
    public NivelDificultad(int idJuego,int userID) {
        idJuegoF=idJuego;
        userIDF=userID;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Selecciona la dificultad del juego");
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 470, 380, 90));
    ...
    private void jPanel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPanel4MouseClicked
        if(idJuegoF==5){
            AnagramaDificil anagramaDificil = new AnagramaDificil(0,5,userIDF,1);
            anagramaDificil.setVisible(true);
            this.dispose();
        }
        if(idJuegoF==6){
            MundoLiterarioDificil mundoLiterarioDificil = new MundoLiterarioDificil(6,userIDF);
            mundoLiterarioDificil.setVisible(true);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NivelDificultad(idJuegoF,userIDF).setVisible(true);
            }
        });
    }
